  ...
  useEffect(() => {
    const fetchAnalyticsData = async () => {
      try {
        ...
        console.log(
          '[AdminAnalytics] Daily revenue data from API:',
          dailyRevenueData,
        );
        ...
        const statusData: OrderStatusData[] = Object.entries(
          ordersByStatus,
        ).map(([status, count]) => ({
        ...
        // Process revenue data for area chart (using daily revenue API)
        const revenueChartData: RevenueData[] = dailyRevenueData.map((item) => {
        ...
        console.log('[AdminAnalytics] Revenue chart data:', revenueChartData);
        setRevenueData(revenueChartData);

        // Process top products data
        const topProducts = productStatsData.topSellingProducts || [];
        const topProductsChartData: TopProductData[] = topProducts.map(
          (product) => ({
